...
const question7 = new Question("Most popular tool that provides version control", 1);
const question8 = new Question("Concept of function calling itself in its body", 3);
const question9 = new Question("Which language is interpreted?", 1);
const question10 = new Question("JSON stands for...", 3);
const question11 = new Question("Data structure that contains pairs of keys and values", 4);
